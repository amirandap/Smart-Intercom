...
telegram_bot = telepot.Bot('BOT:KEY')
bandera = "False"
...
def getCurrentPicture():
	...
	img_data = requests.get(image_url, auth=HTTPBasicAuth('CCTVUSERNAME', 'CCTVPASSWORD')).content
...
def pulsador():
	if (GPIO.input(16)):
		...
		GPIO.output(7, 0)
		if (bandera == "False"):
			print("Esperando telegram para abrir")
			telegram()
		if (bandera == "True"):
			GPIO.output(13, 1)
			time.sleep(2)
...
if __name__ == '__main__':
    ...
    try: 
        ...
        print("Try")
        telegram_bot.sendMessage (569563829, str("Welcome to IntercomPI v4"), 
